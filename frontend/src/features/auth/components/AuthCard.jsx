...
const AuthCard = ({ mode = "register" }) => {
  ...
  return (
    <div className="w-full flex justify-center py-24 px-4 bg-white min-h-screen">
      <div className="w-full max-w-[420px] bg-white rounded-[20px] p-8 flex flex-col items-center border-2 border-duo-gray shadow-[0_8px_24px_rgba(0,0,0,0.05)]">
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-3">
          ...
          {!isLogin && (
            <div className="relative">
              <input 
                ...
                className="w-full px-4 py-4 rounded-xl bg-[#f7f7f7] border-2 border-duo-gray font-semibold text-duo-text placeholder-duo-muted focus:outline-none focus:border-duo-blue focus:bg-white transition-all" 
          ...
          <div className="relative">
            ...
            <button 
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 text-duo-blue hover:text-duo-blue-dark transition-colors"
            >
          ...
          <div className="pt-2">
            <button 
              disabled={isLoading}
              className={`bg-duo-blue hover:bg-[#1899d6] w-full py-4 rounded-xl text-white font-display font-black text-sm tracking-widest uppercase shadow-[0_4px_0_0_#1899d6] active:shadow-none active:translate-y-[4px] transition-all ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
              type="submit"
            >
        ...
        <div className="w-full flex items-center my-8">
          <div className="flex-grow h-[2px] bg-duo-gray"></div>
          <span className="px-4 text-duo-muted font-black text-sm tracking-widest">OR</span>
          <div className="flex-grow h-[2px] bg-duo-gray"></div>
        </div>
        ...
        <div className="w-full flex gap-4 mb-8">
          <button 
            ...
            className="flex-1 flex items-center justify-center gap-3 py-3 border-2 border-duo-gray rounded-xl font-bold text-duo-text text-xs uppercase tracking-wider shadow-[0_2px_0_0_#e5e5e5] active:shadow-none active:translate-y-[2px] transition-all hover:bg-gray-50"
          >
        ...
        <footer className="text-center text-[12px] leading-relaxed text-duo-muted font-bold">
          <p className="mb-4 px-2">
            By signing {isLogin ? "in" : "up"} to SpeakEasy AI, you agree to our 
            <a className="text-duo-blue hover:underline mx-1" href="#">Terms</a> and 
            <a className="text-duo-blue hover:underline mx-1" href="#">Privacy Policy</a>.
          </p>
          <p>
            {isLogin ? "Don't have an account?" : "Already have an account?"}
            <Link 
              className="text-duo-blue hover:underline ml-2 uppercase tracking-wider" 
