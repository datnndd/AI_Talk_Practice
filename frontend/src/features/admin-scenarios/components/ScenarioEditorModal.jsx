...
const ScenarioEditorModal = ({
  ...
  return (
    <div className="fixed inset-0 z-[120] bg-zinc-950/60 p-3 backdrop-blur md:p-6">
      <div className="mx-auto flex h-full max-w-5xl flex-col overflow-hidden rounded-[24px] border border-border bg-card shadow-2xl">
        <div className="flex items-center justify-between border-b border-zinc-200 px-5 py-4">
          ...
          <button
            type="button"
            onClick={onClose}
            className="rounded-xl border border-zinc-200 p-2 text-[var(--page-muted)] transition hover:bg-muted   hover:bg-muted"
          >
            <X size={18} />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="grid min-h-0 flex-1">
          <div className="min-h-0 overflow-y-auto p-5 md:p-6">
            <div className="space-y-5">
              ...
              <section className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <label className="block space-y-2 md:col-span-2">
                    <span className="text-xs font-black uppercase tracking-[0.2em] text-[var(--page-muted)]">Title</span>
                    <input
                      required
                      value={form.title}
                  ...
                  <label className="block space-y-2 md:col-span-2">
                    <span className="text-xs font-black uppercase tracking-[0.2em] text-[var(--page-muted)]">Scenario brief</span>
                    <textarea
                      required
                  ...
                  <label className="block space-y-2 md:col-span-2">
                    <span className="text-xs font-black uppercase tracking-[0.2em] text-[var(--page-muted)] flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="relative flex-1">
                        ...
                        />
                        <div className="flex items-center justify-center gap-2 rounded-xl border border-dashed border-zinc-300 bg-muted px-4 py-3 text-sm font-medium text-[var(--page-muted)] transition hover:bg-muted  /50">
                  ...
                  <label className="block space-y-2">
                    <span className="text-xs font-black uppercase tracking-[0.2em] text-[var(--page-muted)]">Category</span>
                    <input
                      value={form.category}
                  ...
                  <label className="block space-y-2">
                    <span className="text-xs font-black uppercase tracking-[0.2em] text-[var(--page-muted)]">Difficulty</span>
                    <select
                  ...
                  <label className="block space-y-2 md:col-span-2">
                    <span className="text-xs font-black uppercase tracking-[0.2em] text-[var(--page-muted)]">Character</span>
                    <select
              ...
              <section className="grid gap-4 md:grid-cols-2">
                <label className="block space-y-2">
                  <span className="text-xs font-black uppercase tracking-[0.2em] text-[var(--page-muted)]">AI role</span>
                  <input
                    value={form.ai_role}
                ...
                <label className="block space-y-2">
                  <span className="text-xs font-black uppercase tracking-[0.2em] text-[var(--page-muted)]">Learner role</span>
                  <input
              ...
              <section className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-4">
                  <label className="block space-y-2">
                    <span className="text-xs font-black uppercase tracking-[0.2em] text-[var(--page-muted)]">Max time</span>
                    <input
                      type="number"
                      min="1"
                      max="180"
          ...
          <div className="flex items-center justify-between gap-3 border-t border-zinc-200 px-5 py-4">
            <button
              type="button"
              onClick={onClose}
              className="rounded-xl border border-zinc-200 px-4 py-3 text-sm font-semibold text-[var(--page-muted)] transition hover:bg-muted   hover:bg-muted"
            >
              Cancel
            </button>
            <button
